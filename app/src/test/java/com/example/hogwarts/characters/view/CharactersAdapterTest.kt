...
class CharactersAdapterTest {
    ...
    private lateinit var adapter: HouseCharactersAdapter
    private lateinit var viewHolder: HouseCharactersAdapter.MyViewHolder
    ...
    fun setUp() {
        ...
        adapter = HouseCharactersAdapter(mockActivity, characterList)
        viewHolder = HouseCharactersAdapter.MyViewHolder(mockView)
    ...
    fun `test house list is populated` () {
        ...
        adapter = HouseCharactersAdapter(mockActivity, list)
    ...
    fun `test onBindViewHolder views should be bound to expandable view` () {
        val viewHolder = HouseCharactersAdapter.MyViewHolder(mockView)
